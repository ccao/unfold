MODULE para
  ...
  !
INTERFACE para_sync
  MODULE PROCEDURE para_sync_int0, para_sync_int1, para_sync_int2, para_sync_real0, para_sync_real1, para_sync_real2, para_sync_cmplx3
END INTERFACE
  !
...
SUBROUTINE para_sync_int1(dat, dat_size)
  !
  implicit none
  !
  integer :: dat_size
...
SUBROUTINE para_sync_int2(dat, size1, size2)
  !
  implicit none
  !
  integer :: size1, size2
  integer :: dat(1:size1, 1:size2)
  !
